async function checkEmail(e) {
  ...
  // If password already entered (autofill, test runner), proceed directly to login
...
async function loadUserInfo() {
  try {
    ...
    if (staffPreviewing) {
      ...
      if ((path.includes('/student/') || path.includes('student_dashboard.html')) && role !== 'student')  { redirectByRole(role); return; }
